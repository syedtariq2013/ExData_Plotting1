...
plot_topright <- function() {
  plot(dfNewData$DateTime,dfNewData$Voltage,type='l',
       xlab="datetime",
       ylab=col4DfNewData[4])
}
...
plot_bottomright <- function() {
    plot(dfNewData$DateTime,dfNewData$Global_reactive_power,type='l',
         xlab="datetime",
         ylab=col4DfNewData[3] )
}
plot4 <- function() {
  #----------------------------------------------------------------------------
